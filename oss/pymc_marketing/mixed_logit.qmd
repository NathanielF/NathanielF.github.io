...
Mixed logit is the workhorse model behind modern preference estimation, WTP analysis, and market simulations — and it’s now fully Bayesian, transparent, and extensible in PyMC. The model implementation can be found in pymc marketing [here](https://www.pymc-marketing.io/en/stable/notebooks/customer_choice/mixed_logit.html)
