...
I adapted the work of  Martin, Philips and Gelmen’s “Multilevel Regression and Poststratification Case Studies” that can be found [here](https://bookdown.org/jl5522/MRP-case-studies/introduction-to-mister-p.html#estimational-subgroup-level). You can download the worked example [here](mr_p_notebook.html)
