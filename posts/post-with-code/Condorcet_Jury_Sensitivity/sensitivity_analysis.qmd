...
def simulate_irt_data(
    ...
    """
    Backwards-compatible with your original signature, with an optional correlated-error mode.
...
def fit_irt_model(
    ...
    scale_corr_by_difficulty=True,    # match your sim's w(|delta|)
):
    """
