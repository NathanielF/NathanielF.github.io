...
Both calculations are answering related but distinct questions. The former highlights how accuracy should scale under the model; the latter shows how it does scale when individual votes are explicitly realized. Agreement between them is reassuring; divergence is itself diagnostic of the mechanisms that break Condorcet-style aggregation.

We will use both the posterior predictive checks and the posterior implications below. 
