...
You act and learn within constraints - struggling to discern the shape of the tracks on which you travel and the paths available. Hurtling into the future, you pivot at junctions, hoping for the best. You may imagine your next choice will be the one where everything falls into place. All the plans are arrayed, but outcomes are confounded by a plethora of interaction effects and understanding only arrives incrementally. You may seek to learn from the past with a cursory review of history, but detail matters because it structures the implications of future choice. It is these structural details of group membership and hierarchies that determine the path of the tracks, and the architecture the holds up your future. Freedom is not whimsy or wanton action.Choice is free when taken within the confines of tolerable bounds. 
...
Difference in Differences estimation is core a topic in contemporary social science. It is a compelling methodology for licensing inferential statements, but it is not a panacea. The method makes substantive assumptions about the treatment regime and the trends in the process before the treatment is introduced, but it also requires that the data is rich enough to mandate the intended interpretation of a heavily parameterised estimation model. Two-way fixed effects models attempt to tightly estimate the treatment effect by controlling for all sources of variation in our treatment due to group level factors in the DiD designs. These controls isolate the variation due to actual treatment by pinning down the effects of interactions between treatment-units and time. Imagine the true-effect is a sprinter running too fast to cleanly measure - each group interaction effect is added to his load as a weight. Enough weights absorb enough of the variation in the treatment that he is dragged to a crawl and whatever movement he can make while dragging this burden is the effect we attribute to the treatment. We will see how these models and their intended attribution interpretation come apart quickly in the face of staggered treatment roll-outs. We will also show how to fix them.   
