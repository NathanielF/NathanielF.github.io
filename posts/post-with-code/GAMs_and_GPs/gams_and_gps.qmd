...
spline_model1 = bmb.Model(formula_spline, pisa_df, dropna=True)
...
spline_idata1 = spline_model1.fit(random_seed=random_seed, idata_kwargs={"log_likelihood": True}, target_accept=.95)
...
axs[0].set_title("Predictions over the Range of Observed Covariate Values");
