...
To demonstrate how spline modelling can be further adapting to the multiple regression like cases we use the PISA data set discussed in [this case study](https://m-clark.github.io/generalized-additive-models/application.html) from Michael Clark. 
...
Next we'll dig into the spline basis features and decompose the predicted outcome. 

### The Component Contributions

This will also serve as a kind of posterior predictive check for each country as we can show the degree which posterior draws from each component sum to achieve a plausible mirror of the observed data.  
