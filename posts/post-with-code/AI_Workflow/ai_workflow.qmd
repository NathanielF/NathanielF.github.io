...
abstract: "AI-assisted work is often sold on the generative possibilities. The quality comes from diagnostic reflection and iterative refinement. This essay tracks the development of a technical post through 21 commits over 15 days, recording every prompt, every correction, and every modelling decision. The pattern that emerged was consistent: first drafts were competent but inert, and every useful advance began with a diagnosis the tool did not originate. The final product is stronger for the combination, but highlights the irreducible need for style and vision in quality work"
---
