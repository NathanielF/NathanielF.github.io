...
At my most cynical, I think the hype around AI-assisted work is largely driven by the revelatory power of simply writing things down. I've kept a personal blog and a suite of Obsidian notes for years. Writing has always been the most important step in developing quality work. The fact that this realization is advertised as a "breakthrough" explains a lot about our current intellectual climate. To test whether AI can improve work quality, I leaned into the workflow for a recent post: tracking every commit, every prompt, every response, and every revision. The question I wanted to answer was not whether the AI helps (it does) but under what conditions, and at what tasks.
...
Whenever possible, I aim to say something true and interesting. The style, in so far as I have one, is a function of that aim, combined with details of biography and taste. But style is not merely adornment, it constrains vision and focus. These constraints determine what I choose to attend to, what I notice, and how I connect things. Again, attention here is the key. Just as a transformer model architecture develops heuristics for attending to different parts of the input, a writer's style determines relevance. Proust has the line: 
