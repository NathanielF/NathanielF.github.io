...
execute: 
  enabled: true
jupyter: pytorch-env
abstract: "The cost of generating new sample data can be prohibitive. There is a secondary but different cost which attaches to the 'construction' of novel data. Imputation of missing data needs to be handled with care to preserve latent structure alongside plausible realisations. We see these considerations play out in the case of Job satisfaction surveys and non-response patterns."
...
- PCA and SVD
    Linear Decompositions and reconstruction of complex multivariate data sets.
...
- Bayesian Structural Equation Models
    - How the correlation structure can be estimated within a transparent causal structural model
...
var_names=['lambdas1', 'lambdas2', 'lambdas3', 'lambdas4', 'betas'], combined=True);
