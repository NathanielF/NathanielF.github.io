...
execute: 
  enabled: true
jupyter: pytorch-env
abstract: "The cost of generating new sample data can be prohibitive. There is a secondary but different cost which attaches to the 'construction' of novel data. Is the cost worth paying?"
