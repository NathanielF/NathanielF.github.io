...
Here they express the idea that the effects of constructive thought strategies are doubly mediated by an individual's dysfunctional thought processes and their sense of subjective well being. We won't here develop the SEM model, but we'll conclude with the suggestion that complex causal processes require transparent and expressive models for their assessment. 
