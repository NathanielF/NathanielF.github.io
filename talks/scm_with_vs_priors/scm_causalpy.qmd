...
## Who Should Care About This? {.smaller}
...
## The Core Structural Model {.smaller}
...
![](images/parameter_recovery_achieved.webp)
...
::: {.callout-warning}
## The Hard Truth
We can't **prove** $\alpha > 3.3$ But we can:
(1) Show it's **plausible** given domain knowledge
(2) Map the **range** of effects across ρ values
(3) Make **robust decisions** that work across scenarios
:::
