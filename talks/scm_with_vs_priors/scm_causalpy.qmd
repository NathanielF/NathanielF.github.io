...
subtitle: "Finding Structure, Testing Robustness"
...
::: {.callout-important}
## The "Bias Gap"
The difference between 3.3 and 6.2 is the "Cost of Ignorance." By assuming we knew the world, we missed nearly half the effect.
:::
...
The OLS benchmark assumes conditional ignorability. The various joint models allow for latent confounding i.e. that the covariate profile used in the study is not sufficiently exhaustive to block all confounding. 
