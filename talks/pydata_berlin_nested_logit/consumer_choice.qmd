...
- __Bayesian Background__: The Choice Setting
- __The Choice Data__: PyMC-Marketing and Consumer Choice
- __The Tempting Path__: Mulitnomial Logit and the IIA Problem
- __The Branching Path__: Nested Logit and Market Structure
- __Your Path__: Choose your own Adventure
...
## Preference over Worlds {.smaller}

:::: {.columns}

::: {.column width="70%"}
![](images/ranked_worlds.png)
:::
...
Fixing the attributes of different alternatives allows us to __[estimate their desirability]{.blue}__ and course of probable choice.
:::

::::


## Revealed Preference {.smaller}
...
*Each path taken tells a story of preference and reveals something about how the attributes of each alternative __tempt or repel__ the chooser *
:::
...
## From Latent Utility to Observed Choice {.smaller}
...
:::{.r-stack}
<img src="images/pathdiverging.jpeg" alt="Choice" width="800" height="200"/>
...
```{.python code-line-numbers="|2-6|9"}
utility_formulas = [
...
## Market Interventions and Implied Worlds {.smaller}
...
```
Causal Inference with the Do-Operator modifies world-state and data alike allowing for [__compelling intervention studies about consumer behaviour__]{.blue}
...
:::
::: {.fragment .fade-in}
- They also reveal behaviorial insights of consumers unlocking new marketing _strategies for your adventure!_
:::
