...
- The splines smooth across time steps — encoding the assumption that **micro-level noise washes out** in the trajectory. 
- The macro process and the micro counterfactual meet in the same posterior. 
- Sensitivity analysis and LOO-CV tests whether the meeting holds.
