...
The process view doesn't just sidestep the cross-world problem. It **diagnoses** it. Cross-world counterfactuals try to locate causation in a comparison between frozen worlds — but in pre-emption and mediation, the cause is the trajectory that actually transmitted the influence. The micro lens isn't a stricter version of the macro lens. It's looking for causation in the wrong place.
