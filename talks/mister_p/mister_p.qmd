...
### Differences in Strata drawn from Random Distribution
...
$$\gamma_{1,g} \sim Normal(0, \color{purple}\sigma_{i}\color{black}) \text{ for } g \in G$$
...
pd.DataFrame({'g': groups, 'b_g': b_g[grp_indx], 'X0': X[:, 0], 'X1': X[:, 1], 'y': y}).head(10)
