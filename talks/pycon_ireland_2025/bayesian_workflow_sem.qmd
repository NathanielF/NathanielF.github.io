...
![](images/cfa_excalidraw.png){.stretch}

## The SEM Regression

![](images/sem1_excalidraw.png){.stretch}

## The SEM Regression 
### with Mediation Effects

![](images/sem2_excalidraw.png){.stretch}

## The SEM Regression 
### with Staggered Mediation Effects

![](images/sem3_excalidraw.png){.stretch}

## The SEM Regression 
### with Residuals Covariance Structures

![](images/final_sem_excalidraw.png){.stretch}

## The SEM Regression 
### with Hierarchical Structure

![](images/hierarchical_excalidraw.png){.stretch}
...
- Craft, Not Checklist:
  - Like a woodworker, we shape the model layer by layer.
  - Validation is not a single hurdle but a practice of refinement.
...
![](images/cfa_model_summary.png){.stretch}
...
![](images/sem_model_summary.png){.stretch}
...
:::
::: {.column width="30%"}
$$\Sigma_{\mathcal{x}} = \Psi + \\ \Lambda(I - B)^{-1}\Psi_{\gamma}(I - B)^{T}\Lambda^{T} $$
...
![](images/sem_model_marginal_summary.png){.stretch}

## Bayesian Workflow with SEMs
### Comparing Model Estimates

![](images/compare_model_parameters.png){.stretch}