...
$$p(Y​,T, X_{1}…,X_n​)  =  \int p(Y, T, X_{1} ... X_n ​∣\theta)p(\theta)dp(\theta)$$
...
CFA models estimates the multivariate correlation structure while imposing causal structure and dependencies
:::
::: {.column .r-fit-text}
...
![An Inference Engine](images/starON.jpg)
:::
::::
