...
Causal inference in practice needs to be credible. Not all questions can be answered with A/B testing. Your inferential strategies need to be transparent and defensible. 

This is where you should leverage `CausalPy` and Bayesian causal modelling for the quantification of uncertainty and sensitivity analysis.
...
:::
::: {.fragment .fade-in}
- __[Approach]{.green}__: Be attentive to opportunities for natural experiments. Build __[credibility]{.green}__ through linking theoretical estimand and empirical data while __[partnering]{.green}__ across the business with subject matter experts.
:::
:::
